...
{  
    ...
    {  
        ...
        System.out.println("Huffman Kodları: " + huffmanCode);  
        ...
        System.out.println("Kodlanmış string : " + sb);  
        System.out.print("Şifresi çözülmüş string : ");  
        if (isLeaf(root))  
        {  
            while (root.freq-- > 0)   
            {  
